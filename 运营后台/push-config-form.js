(() => {
  ...
  const conditions=[['vip','VIP等级','text',false],['registered','注册时间','datetime-local',true],['login','最后登录时间','datetime-local',true],['recentLoginDays','近几天有登录','days',true],['recentNoLoginDays','近几天未登录','days',true],['recharge','总充值','number',true],['withdraw','总提现','number',true],['package','包ID','text',false],['lastRecharge','最后充值时间','datetime-local',true],['lastWithdraw','最后提现时间','datetime-local',true],['agentCount','代理下级人数','number',true]];
